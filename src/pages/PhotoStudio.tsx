...
import { Camera, Image as ImageIcon, Sparkles, ChevronRight, Download } from 'lucide-react';
...
export default function PhotoStudio() {
  ...
  const handleGenerate = async () => {
    ...
    if (!prompt.trim()) {
      console.error("Por favor, descreva a foto que deseja gerar.");
      return;
    }
    ...
    try {
      ...
      const fullPrompt = `Professional photography, high quality, highly detailed, photorealistic. ${prompt}`;
  ...
  return (
    <div className="max-w-5xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">Estúdio de Foto</h1>
          <p className="text-sm text-gray-400">Gere ensaios fotográficos realistas com IA</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-1/3 bg-[#111111] border border-white/5 rounded-2xl p-6 flex flex-col">
          ...
          <textarea 
            ...
            placeholder="Ex: Um retrato profissional de um homem de negócios em um escritório moderno, iluminação dramática, 8k, photorealistic..."
            value={prompt}
          ...
          <div className="mt-auto pt-4 border-t border-white/5">
            ...
            >
              {isGenerating ? (
                ...
                <>Gerar Foto <ChevronRight className="w-5 h-5" /></>
              )}
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 bg-[#111111] border border-white/5 rounded-2xl flex items-center justify-center p-8 relative overflow-hidden">
          {isGenerating ? (
            <div className="text-center">
              ...
              <p className="text-gray-400 font-medium">Criando sua foto...</p>
            </div>
          ) : resultImage ? (
